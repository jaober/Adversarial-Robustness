"""
Implementation of AggMo optimizer used for training Lipschitz constrained models.
Source: https://arxiv.org/abs/1804.00325
"""
import numpy as np
import torch
...
class AggMo(Optimizer):
    r"""Implements Aggregated Momentum Gradient Descent. https://arxiv.org/abs/1804.00325"""
    def __init__(self, params, lr, momentum=[0.0, 0.9, 0.99, 0.999], weight_decay=0):
